...
{
    /**
     * Returns generated coupon
     *
     * @api
     * @param string $accessKey Better coupon access key
     * @param int $qty coupon qty
     * @param bool $inclMessage
     * @return array Generated coupon of rule.
     */
